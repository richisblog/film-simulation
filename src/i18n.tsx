...
const copy = {
  'zh-CN': {
    ...
    filmSimulation: '胶片模拟', original: '原图', selectOriginal: '选择原图', reset: '重置', exposure: '曝光', filterStrength: '滤镜强度',
  ...
  en: {
    ...
    filmSimulation: 'Film Simulation', original: 'Original', selectOriginal: 'Select original', reset: 'Reset', exposure: 'Exposure', filterStrength: 'Filter strength',
