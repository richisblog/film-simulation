    ...
    try {
      ...
      if (siteUrl) {
        ...
        trackFilterExport({
          ...
          window,
          lutId,
          lutName: lutId ? lutDisplayName(lutId) : null,
        })
      }
...
<footer className="site-footer" role="region" aria-label="支持与反馈">
        ...
        <p className="analytics-privacy-note">为持续优化使用体验，本页面会记录匿名访问及导出所用的滤镜类型；不会上传或保存您的照片、文件名及个人信息。</p>
      </footer>
    </main>
    </>
  )
